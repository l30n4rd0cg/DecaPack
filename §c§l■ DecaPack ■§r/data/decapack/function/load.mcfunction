...
scoreboard objectives add decapack.settings dummy

data modify storage decapack:version version set value "2.0.0a"
...
execute if data storage decapack:version current_std run function decapack:check_upgrades
