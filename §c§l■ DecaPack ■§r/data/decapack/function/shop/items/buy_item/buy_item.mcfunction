...
execute if score decapack tmp1 > decapack money run return run tellraw @s [{"text": "¡No tienes suficiente dinero! El objeto cuesta ", color: "red"}, {score: {name: "@s", objective: "tmp1"}, color: "gold"}, {text: "Ð", color: "gold"}, {text: " y tú tienes ", color: "red"}, {score: {name: "@s", objective: "money"}, color: "gold"}, {text: "Ð", color: "gold"}, {text: ".", color: "red"}]
