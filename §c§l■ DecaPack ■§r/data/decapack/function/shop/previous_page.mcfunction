execute if score @s shop_page matches ..0 run return 0
scoreboard players remove @s shop_page 1
...
execute if score @s tmp1 matches 0 run return run scoreboard players add @s shop_page 1
