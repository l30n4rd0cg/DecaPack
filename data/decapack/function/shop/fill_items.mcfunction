...
#$say {StartSlot: $(StartSlot), Index: $(Index)}
...
#data modify block ~1 ~2 ~ Items append value {id: diamond, Slot: 0b, count: 64, components: {lore: [[{text: "Precio: ", bold: false, italic: false, color: "green"}, {text: "123", bold: false, italic: false, color: "gold"}, {text: "Ð", bold: false, italic: false, color: "gold"}], [{text: "De ", bold: false, italic: false, color: "dark_gray"}, {text: "LeonardoClGo", bold: false, italic: false, color: "dark_gray"}], ""], custom_data: {index: 2}}}
...
#tellraw @s ["index=", {storage: "decapack:tmp_args", nbt: Index}]
...
#execute if score decapack tmp1 matches 27 positioned ~-1 ~ ~ run function decapack:shop/fill_items with storage decapack:tmp_args
